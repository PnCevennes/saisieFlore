<?php
    ...
    $cnxPgBd = new CnxPgBd();
    $req = 'SELECT st_asgeojson(st_transform(pop_geom, 4326)), pop_etiquette, max_zpr_date FROM
        saisie.v_pop_non_revue_maj_station WHERE bio_id = ' . $_GET['bio_id'] .
        ' AND pop_etiquette NOT IN (SELECT pop_etiquette FROM saisie.v_pop_revue_station_maj
