...
<html>
    <head>
        <title>Populations Station</title>
        ...
        <script type='text/javascript' src='../../../Complements/Ext/Spinner.js'></script>
        <script type='text/javascript' src='../../../Complements/Ext/SpinnerField.js'></script>
        ...
        <!--Formulaires -->
        <script type='text/javascript' src='../Controleurs/Formulaires/frmPopStat.js'></script>
        ...
        <script type='text/javascript' src='../Controleurs/CartoGrilles/cgPopStat.js'></script>
    </head>
    <body>
    </body>
</html>
