...
<html>
    <head>
        <title>Populations Enjeux</title>
        ...
        <!--Formulaires -->
        <script type='text/javascript' src='../Controleurs/Formulaires/frmPop.js'></script>
        ...
        <script type='text/javascript' src='../Controleurs/CartoGrilles/cgPop.js'></script>
    </head>
    <body>
    </body>
</html>
