...
<html>
    <head>
        ...
        <!--Formulaires -->
        <script type='text/javascript' src='../Controleurs/Formulaires/frmBioFlo.js'></script>
        <script type='text/javascript' src='../Controleurs/Formulaires/frmTaxFlo.js'></script>
        ...
        <script type='text/javascript' src='../Controleurs/CartoGrilles/cgBioFlo.js'></script>
    </head>
    <body>
    </body>
</html>
